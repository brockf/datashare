...
```{r}
window_start <- 15500 # 15500 includes -500ms pre word onset, set to 16000 for word onset
```
...
write.csv(window_familiar_response, 'window-familiar-response-15.csv')
...
# write to CSV file so we can do age comparisons later
write.csv(window_unfamiliar_response, 'window-unfamiliar-response-15.csv')
